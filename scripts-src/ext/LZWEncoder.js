...
exports.LZWEncoder = function()
{
	...
	maxPixels = imgW * imgH; // reset navigation variables
	curPixel = 0;
    ...
    {
	if (curPixel >= maxPixels) return EOF;
